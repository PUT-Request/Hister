...
// Encryption controls encryption-at-rest of stored HTML/favicon content blobs.
type Encryption struct {
	Enable          bool   `yaml:"enable"           mapstructure:"enable"`
	Password        string `yaml:"password"         mapstructure:"password"`
	AutoLockTimeout string `yaml:"auto_lock_timeout" mapstructure:"auto_lock_timeout"`
}
